  ...
  <Table>
    ...
    <TableBody>
      ...
      <TableRow>
        ...
        <TableCell>
          <ul>
            <li>Must be a list of 20 or fewer</li>
            <li>Each topic must be lowercase</li>
            <li>Each topic must be 50 or fewer characters</li>
            <li>Each topic must contain only letters, numbers, and hyphens</li>
          </ul>
        </TableCell>
      </TableRow>
    </TableBody>

  ...
  <Table>
    ...
    <TableBody>
      <TableRow>
        ...
        <TableCell>`"octorepo"`</TableCell>
      </TableRow>
      <TableRow>
        <TableCell>`textarea`</TableCell>
        <TableCell>`"This is a description!\n\nIt is multiline, too!"`</TableCell>
      </TableRow>
      <TableRow>
        <TableCell>`dropdown`</TableCell>
        <TableCell>`["octocat", "issueops"]`</TableCell>
      </TableRow>
      <TableRow>
        <TableCell>`checkboxes`</TableCell>
        <TableCell>`{ "selected": ["Yes"], "unselected": ["No"] }`</TableCell>
      </TableRow>
    </TableBody>
  </Table>
</TableContainer>
...
<Alert severity="info">Check the workflow comments for useful tips!</Alert>

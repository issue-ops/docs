...
<Note>
  ...
  pipelines to a bed and breakfast reservation system. If you can interact with
  it via an API, there's a good chance you can build it with IssueOps :wink:
</Note>
...
build your own workflows. If you're looking for inspiration, check out the
[Examples](/examples)!

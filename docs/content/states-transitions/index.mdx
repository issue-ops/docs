...
| State       | Description                                                                             |
| ----------- | --------------------------------------------------------------------------------------- |
| `Created`   | The initial state for a new issue that has been opened.                                 |
...
|             | Usually the next immediate state after `Created`.                                       |
...
their inbox, reading it, and doing something._
...
- [Close](/states-and-transitions/close)
...
When an issue is first opened it will be in the `Created` state. Typically, the
...
a descriptive error and return the issue to the `Created` state. When the user
